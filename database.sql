...
CREATE TABLE `user` (
  ...
  `role` enum('system_admin','project_manager','job_seeker') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用户角色',
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户基础信息表';
